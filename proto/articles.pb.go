...
var file_articles_proto_rawDesc = []byte{
	...
	0x74, 0x22, 0x3d, 0x0a, 0x0f, 0x41, 0x72, 0x74, 0x69, 0x63, 0x6c, 0x65, 0x52, 0x65, 0x73, 0x70,
	...
	0x22, 0x40, 0x0a, 0x10, 0x41, 0x72, 0x74, 0x69, 0x63, 0x6c, 0x65, 0x73, 0x52, 0x65, 0x73, 0x70,
	...
	0x65, 0x73, 0x32, 0x9f, 0x02, 0x0a, 0x08, 0x41, 0x72, 0x74, 0x69, 0x63, 0x6c, 0x65, 0x73, 0x12,
	...
	0x63, 0x6c, 0x65, 0x73, 0x42, 0x09, 0x5a, 0x07, 0x2e, 0x3b, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62,
...
var file_articles_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_articles_proto_goTypes = []interface{}{
	...
	(*ArticleResponse)(nil),              // 4: profile.ArticleResponse
	(*ArticlesResponse)(nil),             // 5: profile.ArticlesResponse
	(*CreateAritcleRequest_Article)(nil), // 6: profile.CreateAritcleRequest.Article
	(*timestamp.Timestamp)(nil),          // 7: google.protobuf.Timestamp
	(*Profile)(nil),                      // 8: profile.Profile
}
var file_articles_proto_depIdxs = []int32{
	7, // 0: profile.Article.createdAt:type_name -> google.protobuf.Timestamp
	7, // 1: profile.Article.updatedAt:type_name -> google.protobuf.Timestamp
	8, // 2: profile.Article.author:type_name -> profile.Profile
	6, // 3: profile.CreateAritcleRequest.article:type_name -> profile.CreateAritcleRequest.Article
	0, // 4: profile.ArticleResponse.article:type_name -> profile.Article
	0, // 5: profile.ArticlesResponse.articles:type_name -> profile.Article
	1, // 6: profile.Articles.CreateArticle:input_type -> profile.CreateAritcleRequest
	2, // 7: profile.Articles.GetArticle:input_type -> profile.GetArticleRequest
	3, // 8: profile.Articles.GetArticles:input_type -> profile.GetArticlesRequest
	4, // 9: profile.Articles.CreateArticle:output_type -> profile.ArticleResponse
	4, // 10: profile.Articles.GetArticle:output_type -> profile.ArticleResponse
	5, // 11: profile.Articles.GetArticles:output_type -> profile.ArticlesResponse
